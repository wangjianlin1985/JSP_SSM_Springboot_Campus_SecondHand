		       ...
		       text: "图书类别管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BookClass/bookClass_add.jsp"
			    	   	},
			    		{
			    	   		text: "图书类别管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BookClass/bookClass_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "求购管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BookSeek/bookSeek_add.jsp"
			    	   	},
			    		{
			    	   		text: "求购管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BookSeek/bookSeek_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "图书出售管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "BookSell/bookSell_add.jsp"
			    	   	},
			    		{
			    	   		text: "图书出售管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "BookSell/bookSell_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "图书订单管理",
