    ...
    <div class="container">
        ...
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- <li><a href="<%=basePath %>BookClass/frontlist">图书类别</a></li> -->
                <li><a href="<%=basePath %>BookSeek/frontlist">图书求购</a></li>
                <li><a href="<%=basePath %>BookSell/frontlist">图书出售</a></li>
                <!-- 
                <li><a href="<%=basePath %>BookOrder/frontlist">图书订单</a></li> -->
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel"> 
                        <li><a href="<%=basePath %>BookSeek/bookSeek_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布图书求购</a></li>
                        <li><a href="<%=basePath %>BookSeek/frontUserlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的求购信息</a></li>
                        <li><a href="<%=basePath %>BookOrder/frontUserlist"><span class="glyphicon glyphicon-screenshot"></span>&nbsp;&nbsp;我的订单信息</a></li>
                        <li><a href="<%=basePath %>BookSell/bookSell_frontUserAdd.jsp"><span class="glyphicon glyphicon-credit-card"></span>&nbsp;&nbsp;发布出售图书</a></li>
                        <li><a href="<%=basePath %>BookSell/frontUserlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我发布的出售</a></li>
