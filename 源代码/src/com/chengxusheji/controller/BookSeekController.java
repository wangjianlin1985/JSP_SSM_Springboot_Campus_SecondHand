...
public class BookSeekController extends BaseController {
	...
	public void userAdd(@Validated BookSeek bookSeek, BindingResult br,
		...
		bookSeek.setAddTime(sdf.format(new java.util.Date()));
	...
	public String frontUserlist(String bookName,@ModelAttribute("bookClassObj") BookClass bookClassObj,String publish,String author,String xjcd,@ModelAttribute("userObj") UserInfo userObj,String addTime,Integer currentPage, Model model, HttpServletRequest request,HttpSession session) throws Exception  {
		if (currentPage==null || currentPage == 0) currentPage = 1;
		if (bookName == null) bookName = "";
		if (publish == null) publish = "";
		if (author == null) author = "";
	    ...
	    List<UserInfo> userInfoList = userInfoService.queryAllUserInfo();
	    request.setAttribute("userInfoList", userInfoList);
		return "BookSeek/bookSeek_frontUserquery_result"; 
	}
